...
The canonical instructions are in the repo at [`.cursor/skills/vitest-testing-style/SKILL.md`](../../.cursor/skills/vitest-testing-style/SKILL.md) (path from this file: `../../.cursor/skills/vitest-testing-style/SKILL.md`).

**Before writing or editing tests:** read that file and follow it.
