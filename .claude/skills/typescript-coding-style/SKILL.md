...
The canonical instructions are in the repo at [`.cursor/skills/typescript-coding-style/SKILL.md`](../../.cursor/skills/typescript-coding-style/SKILL.md).

**Before writing or refactoring TypeScript/Vue:** read that file and follow it.
