  ...
  <svg height="0" width="0">
    <symbol id="blueberry" preserveAspectRatio="xMidYMid meet">
      <svg viewBox="0 0 36 36">
        <path
          fill="#5C913B"
          d="M8.089 1s5.858.616 8.54 4.06c3.206 4.117.891 7.962.891 7.962s-4.825-.425-7.03-3.157C7.287 5.896 8.089 1 8.089 1z"
        ></path>
        <path
          fill="#77B255"
          d="M21.901 1s.913 4.617-1.006 7.47c-2.293 3.41-5.676 2.54-5.676 2.54s-.813-3.784.691-6.106C18.096 1.53 21.901 1 21.901 1z"
        ></path>
        <ellipse fill="#5864B7" cx="23.737" cy="11.536" rx="6.916" ry="6.027"></ellipse>
        <path
          fill="#334372"
          d="M19.34 16.996c0-.851-.124-1.64-.34-2.373a12.608 12.608 0 0 1 3.983-.641c2.263 0 4.355.55 6.073 1.562C27.818 17.147 25.7 18 23.292 18c-1.476 0-2.834-.331-3.955-.949c0-.019.003-.036.003-.055z"
        ></path>
        <path
          fill="#334372"
          d="M21.761 16.558c0 .27-.017.531-.04.789c-2.836-.632-4.901-2.641-4.901-5.811c0-.778.129-1.483.359-2.119c2.732 1.246 4.582 3.739 4.582 7.141z"
        ></path>
        <ellipse fill="#5864B7" cx="10.892" cy="16.558" rx="8.892" ry="8.035"></ellipse>
        <path
          fill="#334372"
          d="M10.892 24.091c0-5.278 3.75-8.713 8.687-9.406c.132.589.206 1.213.206 1.872c0 4.984-3.968 8.024-8.867 8.034c-.008-.166-.026-.329-.026-.5z"
        ></path>
        <ellipse
